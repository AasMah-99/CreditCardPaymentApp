...
public class CustomerController {
		...
		public ResponseEntity<Map<String, Object>> addCustomer(@RequestBody Customer customer) throws CustomerNotAddedException {
		...
		public ResponseEntity<Map<String, Object>> updateCustomer(@RequestBody Customer customer,@PathVariable("custId") Long custId)
